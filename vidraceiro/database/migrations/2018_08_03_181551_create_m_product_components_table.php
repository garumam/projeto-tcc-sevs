...
class CreateMProductComponentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('m_product_components', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('m_product_components');
    }
}
