...
<form id="formulario" class="card-shadow-2dp" role="form" method="POST" action="{{ route('password.request') }}" aria-label="{{ __('Resetar Senha') }}">
    @csrf
    ...
    <div class="form-label-group mb-2">
        ...
        <span class="badge badge-danger mt-3">{{ $errors->first('email') }}</span> @endif
    </div>
    <div class="form-label-group">
        ...
        <span class="badge badge-danger mt-3">{{ $errors->first('password') }}</span> @endif
    </div>
