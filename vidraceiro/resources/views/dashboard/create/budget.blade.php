...
<div class="col-12 col-sm-12 col-md-12 col-lg-12">
    <div class="card-material custom-card">
        ...
        <div class="nav nav-tabs" id="nav-tab">
            @for($i = 0; $i< count($titulotabs); $i++) @if($i==0 ) 
            <a class="tabs-budget nav-item nav-link {{ session('tab')? '' : 'current' }}" data-tab="nav-{{$titulotabs[$i]}}-tab"
                data-id="{{lcfirst($titulotabs[$i])}}">{{$titulotabs[$i]}}</a>
                @elseif($i != 0)
                <a class="tabs-budget nav-item nav-link {{ !empty($budgetedit)? '':'disabled' }}" data-tab="nav-{{$titulotabs[$i]}}-tab"
                    data-id="{{lcfirst($titulotabs[$i])}}">{{$titulotabs[$i]}}</a> @endif @endfor
                <div class="topo-tab">
        ...
        <div id="nav-{{$titulotabs[0]}}-tab" class="tab-content current">
            ...
            <form id="form-product" class="formulario" method="POST" role="form" action="{{ !empty($budgetedit) ?  route('budgets.update',['id'=>$budgetedit->id,'tag' => '1']) :  route('budgets.store')}}">
                @if(!empty($budgetedit))
                <input type="hidden" name="_method" value="PATCH"> @endif
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="select-cliente" class="form-control form-control-chosen" name="cliente_id" data-placeholder="Selecie um cliente(opcional)"
                            style="display: none;">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome" value="{{$budgetedit->nome or old('nome')}}"
                            required>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" id="margem_lucro" name="margem_lucro" placeholder="100" value="{{$budgetedit->margem_lucro or old('margem_lucro')}}">
                    </div>
        ...
        <div id="nav-{{$titulotabs[1]}}-tab" class="tab-content">
            ...
            <form class="formulario" method="POST" role="form" action="{{route('budgets.update',['id'=>$budgetedit->id,'tag' => '2'])}}">
                ...
                <div class="form-row align-items-center">
                    <div class="form-group col-">
                        <img id="image-mproduto" src="{{ '/img/semimagem.png' }}" class="img-fluid" alt="Responsive image" style="height: 110px!important;">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="localizacao" name="localizacao" placeholder="Localização" value="{{old('localizacao')}}">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="valor_mao_obra">Valor da mão de obra</label>
                        <input type="number" step=".01" class="form-control" id="valor_mao_obra" name="valor_mao_obra" placeholder="" value="{{old('valor_mao_obra')}}">
                    </div>
        ...
        <div id="nav-{{$titulotabs[2]}}-tab" class="tab-content">
            ...
            <form class="formulario" method="POST" role="form" action="{{route('budgets.update',['id'=>$budgetedit->id,'tag' => '3'])}}">
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="form-group col-">
                        <img id="image-produto-editar" src="{{ '/img/semimagem.png' }}" class="img-fluid" alt="Responsive image" style="height: 110px!important;">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="localizacao-edit" name="localizacao" placeholder="Localização" value="{{old('localizacao')}}">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="valor_mao_obra-edit">Valor da mão de obra</label>
                        <input type="number" step=".01" class="form-control" id="valor_mao_obra-edit" name="valor_mao_obra" placeholder="" value="{{old('valor_mao_obra')}}">
                    </div>
        ...
        <div id="nav-{{$titulotabs[3]}}-tab" class="tab-content pb-5">
            ...
            <form class="formulario" method="POST" role="form" action="{{route('budgets.update',['id'=>$budgetedit->id,'tag' => '4'])}}">
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="form-group col-">
                        <img id="image-produto-material" src="{{ '/img/semimagem.png' }}" class="img-fluid" alt="Responsive image" style="height: 110px!important;">
                    </div>
        ...
        <div id="nav-{{$titulotabs[4]}}-tab" class="tab-content">
            @php $id = $budgetedit->id 
            @endphp
            <form class="formulario" method="GET" role="form" target="_blank" action="{{ route('pdf.show',['tipo'=>'budget','id'=>$id]) }}">
                    ...
                    <div class="card-material custom-card custom-card-total col-md p-3">
                        ...
                        <div class="card-text">
                            ...
                            <label>Produto: {{$product->mproduct->nome}}
                                                ...
                                                Qtd: {{$product['qtd']}}</label> @endforeach
                ...
                <div class="form-row">
                    ...
                    <div class="card-material custom-card custom-card-total col-md p-3">
                        ...
                        <div class="card-text">
                            @foreach($products as $product)
                            <label><b>Vidros do produto: {{$product->mproduct->nome}}</b></label> @foreach($product->glasses
                            as $glass)
                            <label>Nome: {{$glass->nome .' '. $glass->tipo .' | Preço(m²): R$'. $glass->preco}}{{' | Preço total: R$'.number_format((($product->largura * $product->altura) * $glass->preco),2,'.','')}}</label>                            @endforeach @endforeach
                        </div>
                        @endif
                ...
                <div class="form-row">
                    ...
                    <div class="card-material custom-card custom-card-total col-md p-3">
                        ...
                        <div class="card-text">
                            @foreach($products as $product)
                            <label><b>Alumínios do produto: {{$product->mproduct->nome}}</b></label> @foreach($product->aluminums
                            as $aluminum)
                            <label>Perfil: {{$aluminum->perfil .' '. $aluminum->descricao .' | Peso: '.$aluminum->peso.' | Qtd: '.$aluminum->qtd . ' | Preço(kg): R$ '.$aluminum->preco.' | Preço total: R$'.number_format((($aluminum->preco * $aluminum->peso) * $aluminum->qtd),2,'.','')}}</label>                            @endforeach @endforeach
                        </div>
                        @endif
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="card-material custom-card custom-card-total col-md p-3">
                        ...
                        <div class="card-text">
                            @foreach($products as $product)
                            <label><b>Componentes do produto: {{$product->mproduct->nome}}</b></label> @foreach($product->components
                            as $component)
                            <label>Nome: {{$component->nome.' | Qtd: '.$component->qtd .' | Preço(uni): R$ '.$component->preco.' | Preço total: R$'.number_format(($component->preco * $component->qtd),2,'.','')}}</label>                            @endforeach @endforeach
                        </div>
                        @endif
                    </div>
